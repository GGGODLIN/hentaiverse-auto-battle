...
1. **Dashboard** — 開關 Arena Sweep、遭遇戰農怪、無人值守模式
2. **戰鬥設定** — 在 Dashboard 設定技能、藥水、門檻值與策略
3. **Arena Sweep** — 點擊 ON，擴充功能自動處理：進入競技場 → 戰鬥 → 下一難度 → 重複
4. **遭遇戰** — 啟用後自動在競技場間隔檢查 e-hentai.org/news.php
